...
interface PlantSaveProps extends NativeStackHeaderProps {}

interface Params {
  plant: PlantProps;
}

export function PlantSave({ route, navigation }: PlantSaveProps) {
  ...
  async function handleSave() {
    try {
      ...
      navigation.navigate('Confirmation', {
        title: 'Tudo certo',
        subtitle: 'Fique tranquilo que sempre camps lembrar você de cuidar da sua plantinha com muito cuidado.',
